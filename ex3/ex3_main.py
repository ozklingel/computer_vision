...
def lkDemo(img_path):
    ...
    step_size = 20
    win_size = 5
    pts, uv = opticalFlow(img_1.astype(np.float), img_2.astype(np.float), step_size, win_size)
    et = time.time()
...
def main():
    img_path = 'data/basketball1.png'
    #lkDemo(img_path)
    #pyrGaussianDemo('data/basketball1.png')
    #pyrLaplacianDemo('data/basketball1.png')
    blendDemo()
